...
**Go offline (no internet) before running the integration tests.** Otherwise, the torrents will show nonzero progress and the screenshots won't match exactly.Also, move your mouse to the side of the screen to avoid extra hovers.

**If you're on a Mac, you'll need a Retina display.**
